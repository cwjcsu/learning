...
/**
 * Holds 2 values, useful when we have a map with a key, but more than 1 value
 * and we don't want to create a separate holder object for the values, and
 * don't want to pass the values as a list or array.
 * 
 * @author atlas
 * 
 * @param <V1>
