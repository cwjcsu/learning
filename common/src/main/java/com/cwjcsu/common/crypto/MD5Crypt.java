...
public class MD5Crypt {
    ...
    public static String crypt(String key, String s) {
        ...
        try {
            ...
            throw new RuntimeException("Problem getting MD5 message digest " +
    ...
    /**
     * verify that whether encryptedText is encrypted from plaintext.
     * @param planText
     * @param encryptedText
     * @return
     */
    public static boolean verify(String plaintext,String encryptedText){
    	return crypt(plaintext, encryptedText).equals(encryptedText);
    }
