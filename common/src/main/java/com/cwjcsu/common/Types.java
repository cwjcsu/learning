...
/**
 *处理泛型参数的工具类，获取参数化的泛型类、参数化数组、以及用通配符代表的子类和父类的Type 
 * @author atlas
 * @date 2013-4-8
 */
public class Types {
	...
	/**
	 * <p>
	 * 返回参数化类型：{@code your.pkg.Ower$Raw<T1,T2,T3>}应该设置参数为
	 * {@code (Ower.class,Raw.class,new Type[] T1.class,T2.class,T3.class})}
	 * 当没有外部类时，使用null。
	 * <p>
